...
- [bridgeforge-doc-runtime-packaging](bridgeforge-doc-runtime-packaging.md) — BridgeForge 的运行手册统一位于 doc/runtime；只有该子树随 bridgeforge command bundle 分发，其余 doc 只留在工厂仓库。
