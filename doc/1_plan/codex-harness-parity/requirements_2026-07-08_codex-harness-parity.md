...
- [x] 新增只读 harness parity 检查脚本，可生成/刷新 `docs/codex-harness-parity.md`。
...
- 新增 `templates/codex/scripts/harness_parity_check.py` 并 dogfood 到 `.codex/scripts/`，生成 `docs/codex-harness-parity.md`。
