...
ALL_METADATA_HOOKS = (
    ...
    (".codex", ROOT / "templates" / "codex" / "hooks" / "skill_metadata_check.py"),
    (".claude", ROOT / ".claude" / "hooks" / "skill_metadata_check.py"),
    (".claude", ROOT / "templates" / "claude" / "hooks" / "skill_metadata_check.py"),
)
